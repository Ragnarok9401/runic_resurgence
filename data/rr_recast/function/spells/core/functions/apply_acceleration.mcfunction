...
execute store result score @s rr.math.A run data get entity @s data.projectile.speed 10000
...
execute store result entity @s data.projectile.speed float 0.0001 run scoreboard players get @s rr.math.A
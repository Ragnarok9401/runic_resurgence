# Long Delay on Spell Startup that gives 4 seconds to aim the spell sent, or to simply prevent instantaneous execution
scoreboard players add @s rr.stats.SpellsCast 1
scoreboard players set @s rr.spell.SpellStart 80

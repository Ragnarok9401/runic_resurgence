...
execute as @s[tag=RunicLeapSpell,tag=RunicSpellRun] at @s run scoreboard players add @s rr.system.Timer 60
execute as @s[tag=RunicLeapSpell,tag=RunicSpellRun] at @s run scoreboard players remove @s rr.spell.MemTCD 60
